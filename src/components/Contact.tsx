          ...
          >
            ...
            <motion.div variants={itemVariants} className="lg:col-span-2">
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-blue-500/10 via-blue-600/5 to-blue-700/10" />
                ...
                <div className="relative space-y-6">
                  ...
                  <motion.button
                    ...
                    className="w-full relative overflow-hidden px-8 py-3 bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 text-white font-semibold rounded-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed group shadow-lg hover:shadow-2xl"
                  >
